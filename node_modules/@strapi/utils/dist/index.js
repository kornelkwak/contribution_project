...
const ___default = /* @__PURE__ */ _interopDefault(_$2);
...
const isObj$3 = (value2) => _$2.isPlainObject(value2);
const templateConfiguration = (obj, configPath = "") => {
  return Object.keys(obj).reduce((acc, key) => {
    const value = obj[key];
    if (isObj$3(value) && !_$2.isString(value)) {
      acc[key] = templateConfiguration(value, `${configPath}.${key}`);
    } else if (_$2.isString(value) && !excludeConfigPaths.includes(configPath.substr(1)) && value.match(regex) !== null) {
      acc[key] = eval("`" + value + "`");
    } else {
      acc[key] = value;
    }
...
const toKebabCase = (value2) => _$2.kebabCase(value2);
