...
const handlerControllerFactory = (implementation) => (options) => {
    ...
    return async (ctx) => {
                ...
                async executeAndRespond(uuid, fn) {
                    try {
                        ...
                        if (e instanceof Error) {
                            ...
                            await this.respond(uuid, new providers_1.ProviderTransferError(e)).catch(cannotRespondHandler);
                        }
                        else {
                            await this.respond(uuid, new providers_1.ProviderTransferError('Unexpected error', {
                                error: e,
        ...
        try {
            (0, exports.handleWSUpgrade)(wss, ctx, cb);
        }
        catch (err) {
